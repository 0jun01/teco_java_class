...
public class DataType1 {
	...
	public static void main(String[] args) {
		...
		byte byteBox;	// 1바이트	-> 네모칸 한칸은 1bit --> 8bit가 모이면 --< 1byte;
		...
		byteBox = -128;
		byteBox = 127; // 담을수 있는 범위가 -128 ~ 127
		
		shortBox = -32768;
		shortBox = 32767; // 담을 수 있는 범위 -32768 ~ 32767
		
		// 약+- 21억까지 사용 가능 하다.
		intBox = -2147483648;
		intBox = 217483647; // -2147483648 ~ 2147483647
		
		// 약 경까지
		longBox = -9223372036854775808L; // 숫자 마지막에 L은 접미사라고 합니다.
		longBox = 9223372036854775807L; // int 값이 아니라 long 값이라고 표시 용도
		
		// L value = R value
		// 보통 오른쪽에 기술 되는 수의 기본 단위는 4바이트 크기의 int 형으로 먼저 인지한다.
