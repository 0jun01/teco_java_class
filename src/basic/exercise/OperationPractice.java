...
public class OperationPractice {
	...
	public static void main(String[] args) {
		...
		System.out.println(" 1번의 답은 : " + result1);

		// 2. result1 변수를 정수형으로 강제 형 변환 해서 출력하세요
		System.out.println(" 2번의 답은 : " + (int)result1);
		
		// 3. intData 변수에서 -1을 뺀 후 출력하세요
		// 단, 단항 연산자 사용
		--intData;
		System.out.println(" 3번의 답은 : " + intData);
		
		
		// 4. doubleData 변수에 값을 -20.5로 출력 하세요
		// 단, doubleData 값을 변경하지 마세요
		System.out.println(" 4번의 답은 : " + -doubleData);
