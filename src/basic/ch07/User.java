...
public class User {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------");
		// 참조 변수 user2 기능인 checkPassword를 호출해서 결과를 확인 해주세요
		// -- F
		// -- T
		...
		boolean user2result1 = user2.checkPassword("333");
		System.out.println("user2 첫번째 결과 : " + user2result1);

		boolean user2result2 = user2.checkPassword("555");
		System.out.println("user2 두 번째 결과 : " + user2result2);

		if (user2result2 == true || user2result1 == true) {
