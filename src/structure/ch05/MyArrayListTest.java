...
public class MyArrayListTest {
	...
	public static void main(String[] args) {
		...
		ArrayList list = new ArrayList(); // 쓸려면 메모리에 올려야 한다.
		// 제네릭은 추후 더 설명 <E>
		// 제네릭은 타입의 명시화이다.
		ArrayList<Integer> nums = new ArrayList<Integer>();
		// 변수에 선언과 동시에 초기화 ---> 값이 들어가 있는 상태인가?
		// 값을 동시에 추가 하고 싶다면 밑에 처럼
		ArrayList<Integer> num2 = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5)); // 생략 가능
		// 문자열만 담을 수 있는 자료구조
